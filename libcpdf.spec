...
Summary(pl):	Biblioteka do obrÛbki plikÛw PDF
Name:		libcpdf
Version:	2.02r1
...
%description -l pl
To jest biblioteka funkcji ANSI C do tworzenia plikÛw PDF bezpo∂rednio
z C.

%package devel
Summary:	Header files needed for libcpdf development
Summary(pl):	Pliki nag≥Ûwkowe do programowania z uøyciem libcpdf
...
Ten pakiet zawiera pliki nag≥Ûwkowe potrzebne do programowania z
uøyciem libcpdf.
